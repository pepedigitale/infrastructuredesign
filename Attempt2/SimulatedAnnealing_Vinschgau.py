...
GAP_MIN_MINUTES = SLOW_TRAVEL_MIN - FAST_TRAVEL_MIN + 3  # 84 - 58 = 26
...
def enforce_no_overtake(solution):
    ...
    for slow1_idx, slow2_idx, fast_idx in [(0, 1, 2), (3, 4, 5)]:
        ...
        # Correct: l_last is whichever slow train the fast train must clear first
        gap_12 = (sl2 - sl1) % 60
        if gap_12 <= 30:
            l_first, l_last = sl1, sl2   # sl2 comes after sl1
        else:
            l_first, l_last = sl2, sl1   # sl1 comes after sl2
...
def plot_results(best_sol, best_cost, cost_history):
    """
    Produce due grafici:
    ...
    plt.savefig("merano_malles_risultato.png", dpi=150, bbox_inches="tight")
    print("\nGrafico salvato in: merano_malles_risultato.png")
    plt.show()
...
if __name__ == "__main__":
    ...
    best_sol, best_cost, cost_history = simulated_annealing()
